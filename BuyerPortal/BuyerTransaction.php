...
<li class="ash1"><i class="fas fa-map-marker-alt order order4"></i><br><i class="fa fa-times aria" aria-hidden="true"></i><<br>Reached</li>
    ...
    <div class="instaid">
        <div class="text"><a href="#" style="color:black;">@FRESH TO FARM DAIRY PRODUCTS</a></div>

        <div class="gmailid">
            <a href="#" class="hypher" style="color:black;">FRESH@gmail.com</a>
        </div>

    </div>
    <div class="copy">
        <h5 style="test-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2022 by www.FRESH TO FARM DAIRY PRODUCTS.com</h5>
    </div>
