      ...
      <body>
           ...
           <nav class="navbar navbar-expand-xl ">
                ...
                <a class="float-left" href="farmerHomepage.php">
                    <h1 class="logo">FRESH TO FARM DAIRY PRODUCTS </h1>
                ...
                <div class="container">
                     ...
                     <div class="row">
                          <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                               <p><u><a href="https://www.agrocraft.com/">FRESH TO FARM DAIRY PRODUCTS </a></u> is a Multitrading Company for farmers ang traders</p>
                               <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="https://www.google.com" target="_blank">FTFDP</a></p>
                          </div>
                          </hr>
                     </div>
                </div>
